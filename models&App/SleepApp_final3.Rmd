...
valueBox(total, "Total", icon = "ion-android-contact")
```

### Average sleep hours
```{r}
hours <- 7.6
valueBox(hours, "Average Sleep Hours", icon = "ion-android-stopwatch")
```

### % Trouble sleeping
```{r}
valueBox(scales::percent(.285), "Percent", icon = "ion-battery-low")
...
library(ggstance)
renderPlot({ 
plot_summs(logitMod,coefs =  c("Snort:5 times/week"="snort5/wk","Move Object Difficult: Much"="difficult_move_objectsmuch","Age Range: 36-50"="age.cat236-50","Anxious frequency: weekly"="anxiousweekly"),scale = TRUE, plot.distributions = TRUE, inner_ci_level = .9)
})
```
